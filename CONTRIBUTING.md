...
Looking to contribute something to Pipeline? Here's how you can help.
...
4. Please try to be as detailed as possible in your report. Include specific
   ...
   and version, version of Pipeline – and steps required to reproduce the issue.
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/pipeline
...
3. Install the dependencies (you must have JDK 7 or higher
...
4. Make sure to update, or add to the tests when appropriate. Patches and
   features will not be accepted without tests. Run `gradlew check` to check that
